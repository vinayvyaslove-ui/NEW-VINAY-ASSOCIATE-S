...
// data.user exists here only if "email confirmation" is disabled on Supabase
...
return ( <main className="min-h-screen p-8"> <h2 className="text-2xl font-bold mb-4">Authentication</h2>
